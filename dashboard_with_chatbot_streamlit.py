...
.block-container { padding: 2.2rem 2.8rem 3.2rem !important; max-width: 1500px; }

/* ── Sidebar ── */
[data-testid="stSidebar"] {
    background: linear-gradient(175deg, #1A2340 0%, #0F1628 100%) !important;
...
[data-testid="stSidebar"] div { font-size: 1.06rem !important; }

/* ── Headings ── */
h1 { font-size: 3.0rem !important; font-weight: 900 !important;
     color: #0F1628 !important; letter-spacing: -0.02em !important;
     margin-bottom: 0.1rem !important; }
h2 { font-size: 2.0rem !important; font-weight: 800 !important; color: #1C2541 !important; }
h3 { font-size: 1.45rem !important; font-weight: 700 !important; color: #1C2541 !important; }
p  { font-size: 1.12rem  !important; color: #3D3D3D !important; }
...
.kpi-label {
    ...
    color: #777 !important; margin-bottom: 0.5rem;
}
.kpi-num { font-size: 2.55rem !important; font-weight: 900 !important;
           line-height: 1.05; letter-spacing: -0.03em;
           white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis !important; }
.kpi-sub { font-size: 1.0rem !important; color: #888 !important;
           margin-top: 0.35rem; font-weight: 500; }

/* ── Section label ── */
.sec-lbl {
    font-size: 0.98rem !important; font-weight: 800 !important;
    letter-spacing: 0.13em !important; text-transform: uppercase !important;
    color: #555 !important; border-bottom: 2px solid #E8E2DA;
...
[data-testid="stTabs"] button {
    ...
    color: #555 !important; padding: 0.6rem 1.4rem !important;
    letter-spacing: 0.01em;
}
...
input, select, textarea { font-size: 1.12rem !important; color: #1C1C1C !important; }

/* ── Expander ── */
[data-testid="stExpander"] summary {
    font-size: 1.18rem !important; font-weight: 700 !important; color: #1C2541 !important;
}

/* ── DataFrame ── */
[data-testid="stDataFrame"] { font-size: 1.06rem !important; }
[data-testid="stDataFrame"] th {
    font-size: 1.08rem !important; font-weight: 800 !important; color: #1C1C1C !important;
}
[data-testid="stDataFrame"] td { font-size: 1.02rem !important; color: #2D2D2D !important; }

/* ── Caption / info ── */
[data-testid="stCaptionContainer"], .stCaption {
    font-size: 1.02rem !important; color: #666 !important; font-weight: 500 !important;
}
...
[data-testid="stFormSubmitButton"] button, .stButton button {
    ...
    border-radius: 10px !important; padding: 0.85rem 2.25rem !important;
    background: linear-gradient(135deg, #1A2340, #283593) !important;
    color: #FFFFFF !important; border: none !important;
    box-shadow: 0 4px 16px rgba(26,35,64,0.35) !important;
    letter-spacing: 0.02em;
}
[data-testid="stFormSubmitButton"] button:hover, .stButton button:hover {
    transform: translateY(-1px) !important;
    box-shadow: 0 7px 22px rgba(26,35,64,0.45) !important;
}

/* ── Divider ── */
hr { border-color: #E8E2DA !important; margin: 1.2rem 0 !important; }

/* ── Multiselect tags ── */
[data-testid="stMultiSelect"] span[data-baseweb="tag"] {
    background-color: #1A2340 !important; color: #FFFFFF !important;
...
def chart_base(height=400):
    ...
    return dict(
        ...
        plot_bgcolor="#FAF8F5",
        font=dict(family="Segoe UI, Arial", size=20, color="#1C1C1C"),
        margin=dict(t=60, b=70, l=40, r=40),
        legend=dict(font=dict(size=17, color="#1C1C1C"),
...
AXIS_STYLE = dict(
    gridcolor="#EDE8E0",
    linecolor="#C8C0B5",
    tickfont=dict(size=18, color="#2D2D2D"),
    title_font=dict(size=20, color="#1C1C1C"),
    showgrid=True,
)
